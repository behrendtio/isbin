 ...
 * @param  {Function(result)} thereChecked  Callback when check is done async, optional
 * @return {Boolean}                        True if binary was found
 */

function isbin(bin, additional, thereChecked) {
  // isbin(bin, cb)
  if (!thereChecked) thereChecked = additional;
